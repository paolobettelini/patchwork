...
- [Mods and Cargo metadata](./mods.md)
- [Dependencies and lifecycle](./dependencies_lifecycle.md)
- [Modpacks](./modpacks.md)
- [Composer](./composer.md)
- [Composed project](./composed_project.md)
- [Generic codegen](./codegen.md)
- [Example: network messages](./network_messages.md)
- [Avoiding dependency cycles](./avoiding_cycles.md)
...
- [Practical workflows](./workflows.md)
- [Guide for LLMs and contributors](./llm_guide.md)
